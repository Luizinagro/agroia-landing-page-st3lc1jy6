  ...
  try {
    ...
    if (!forecastData) {
      forecastData = {
        ...
        risco_pragas: "Médio",
        analise_climatica: "Condições majoritariamente favoráveis, com alerta para possível déficit hídrico nas próximas semanas.",
        qualidade_solo: "Níveis adequados de macronutrientes, porém requer atenção à correção de acidez baseada no histórico.",
        recomendacoes: [
