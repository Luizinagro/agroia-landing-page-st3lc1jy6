...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (apiKey) {
      ...
      O preço atual da unidade de medida padrão (saca, tonelada, arroba) é R$ ${currentPrice}. 
      ...
      Gere exatos 60 itens em trend_data. O valor "price" em trend_data deve ser o preço da unidade.`
