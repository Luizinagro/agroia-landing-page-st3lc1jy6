...
export function CrmOverview() {
  return (
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-primary/20 bg-primary/5 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-primary">Receita AgroIA</CardTitle>
            <DollarSign className="h-4 w-4 text-primary" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white tracking-tight">R$ 58.240</div>
        ...
        <Card className="bg-[#050505] border-white/10 shadow-lg">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Propriedades monitoradas</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="bg-[#050505] border-white/10 shadow-lg">
        <CardHeader>
          <CardTitle className="text-white">Crescimento de Receita Mensal (MRR)</CardTitle>
        </CardHeader>
