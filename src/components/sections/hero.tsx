    ...
    >
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-7xl mx-auto">
          {/* Main Content Block */}
          <div className="lg:col-span-7 bg-[#050505]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 md:p-14 flex flex-col justify-center relative overflow-hidden group hover:border-white/20 transition-colors duration-500 gsap-grow">
            ...
            <h1 className="text-[#FFFFFF] mb-6 font-black tracking-tighter leading-[1.1]">
              ...
              <span className="text-zinc-400">Agronômica</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <NeonLink
                to="/cadastro"
                variant="solid"
                className="flex items-center justify-center gap-2 group/btn py-4 px-8 text-base bg-white hover:bg-zinc-200 text-black font-black"
              >
                Comece Agora
              ...
              <NeonButton
                ...
                className="flex items-center justify-center bg-white/5 backdrop-blur-md py-4 px-8 text-base hover:bg-white/10 transition-colors text-white border border-white/10"
              >
                Ver Planos
              </NeonButton>
            </div>
          ...
          <div className="lg:col-span-5 grid grid-rows-2 gap-6 gsap-stagger-container">
            {/* Top Widget */}
            <div className="bg-[#050505]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 relative overflow-hidden flex flex-col justify-between group hover:border-white/30 transition-colors duration-500 gsap-stagger-item">
              <div className="flex justify-between items-start mb-4 z-10 relative">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                  <TrendingUp className="w-6 h-6 text-white" />
                </div>
                <span className="text-black font-black text-sm bg-white px-3 py-1 rounded-full">
                  +14.5%
                </span>
              </div>
              ...
              <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-white/10 to-transparent opacity-50" />
            </div>

            {/* Bottom Widgets */}
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-zinc-900 border border-white/10 rounded-[32px] p-6 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 gsap-stagger-item">
                <Tractor className="w-8 h-8 text-white mb-4" />
                <div>
                  <p className="text-white/70 font-bold text-sm mb-1 uppercase tracking-wider">
                    Precisão IA
                  </p>
              ...
              <div className="bg-[#050505]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-6 flex flex-col justify-between group hover:border-white/30 transition-colors duration-500 gsap-stagger-item">
