  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none gsap-parallax-hero bg-gradient-hero bg-cover bg-center bg-fixed">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#00FF41]/10 rounded-full blur-[120px] mix-blend-screen animate-float"
      ...
      <div className="container relative z-10 flex flex-col items-center text-center">
        <AnimatedSection className="max-w-5xl space-y-8 flex flex-col items-center gsap-grow">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-[8px] bg-[#1A1F3A]/50 border border-[#00FF41]/20 backdrop-blur-md mb-4 animate-fade-in-down">
