...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-[24px] border border-white/10 bg-[#111827]/40 backdrop-blur-[20px] text-card-foreground shadow-sm transition-all duration-400 ease-bounce hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(34,197,94,0.15)] hover:border-white/20',
        className,
      )}
      {...props}
    />
