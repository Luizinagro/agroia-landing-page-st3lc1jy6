...
const Dashboard = () => {
  ...
  return (
    <div className="flex-1 text-white animate-fade-in font-sans selection:bg-primary/30 max-w-7xl mx-auto w-full space-y-10 pb-10">
      <SEO
        title="Dashboard"
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 mt-2">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Visão Geral</h1>
          <p className="text-[#A0A0A0] text-lg font-medium">
            Acompanhe as principais métricas da sua operação.
          </p>
        </div>
        {isAdmin && (
          <div className="bg-primary/10 border border-primary/30 text-primary px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-[0_0_15px_rgba(29,185,84,0.15)] animate-pulse-slow">
        ...
        <DialogContent className="bg-[#0A0A0A] border border-primary/20 text-white sm:max-w-[425px] rounded-[24px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-[#A0A0A0] mt-2">
              Esta funcionalidade é exclusiva para planos superiores. Faça upgrade para desbloquear
              todo o potencial da AgroIA.
            </DialogDescription>
          </DialogHeader>
